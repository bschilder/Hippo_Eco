...
HR_phylo <- contMap(HP$phy, HP$data$Home_Range, type="phylogram", plot=FALSE)
  plot(res_phylo_plot, leg.txt="Home Range",lwd=3, fsize=c(0.5, 1)) 
...
# Simple biplot
biplot(phy.PCA$S, phy.PCA$L, xlabs=rep("o", nrow(phy.PCA$S)), main = "Phylogenetic PCA: PC Axes", col=c("blue","purple") )
...
PCs1_4.pBIC <- l1ou(tree, dat=pcDF, model="pBIC", multi=T, abbrev_species = T)
```
